        ...
        <div class="sidebar-wrapper">
            <div class="sidebar-header position-relative">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="logo">
                        <a href="index.html"><img src="<?= base_url('assets/image/logo-sn.png') ?>" alt="Logo" srcset=""></a>
                    </div>
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <!-- Sidebar Title -->
                    <li class="sidebar-item" id="sidebar-kategori">
                        <a href="<?= base_url('app/kategori') ?>" class='sidebar-link'>
                            <i class="bi bi-tag"></i>
                            <span>Kategori</span>
                        </a>
                    </li>
                    <!-- Sidebar Title -->
                    <li class="sidebar-item" id="sidebar-logout">
