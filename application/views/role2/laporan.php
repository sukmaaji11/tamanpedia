    ...
    <script>
        ...
        function sendWhatsapp() {
            ...
            Promise.all([
                ...
                const danaTersedia = totalPemasukan - totalPengeluaran;
                var text = "Laporan%20Keuangan%20Masjid%20Nur%20-%20Hidayah%20Tamansari%20-%20" + startDate + " " + "to" + " " + endDate + "%0A%0ATotal%20Pengeluaran%20%3A%20Rp%20" + formatRupiah(totalPengeluaran.toString()) + "%0A%0ATotal%20Pemasukan%20%3A%20Rp%20" + formatRupiah(totalPemasukan.toString()) + "%0A%0ADana%20Tersedia%20%3A%20Rp%20" + formatRupiah(danaTersedia.toString()) + "%0A%0ASelengkapnya%20%3A%20%0Atamanpedia.bra-dev.com%2Flaporan%2Fpreview%2F" + startDate + "%2F" + endDate + "";
