    ...
    <script>
        ...
        function sendWhatsapp() {
            ...
            Promise.all([
                ...
                // Calculate totals
                const totalPemasukan = tempPemasukan.reduce((sum, item) => sum + parseFloat(item.pemasukan_total), 0);
                const totalPengeluaran = tempPengeluaran.reduce((sum, item) => sum + parseFloat(item.pengeluaran_total), 0);
                const danaTersedia = totalPemasukan - totalPengeluaran;
