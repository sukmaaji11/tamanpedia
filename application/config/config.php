...
|
*/
$config['base_url'] = 'https://tamanpedia.bra-dev.com/';
...
$config['cookie_path']     = '/';
$config['cookie_domain']   = $_SERVER['HTTP_HOST']; // Auto-detect domain
$config['cookie_secure']   = isset($_SERVER['HTTPS']); // Auto-detect HTTPS
